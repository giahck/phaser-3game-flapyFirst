...
class PlayScene extends BaseScene{
   ...
   placePipe(uPipe, lPipe) {
     const difficulty = this.difficulties[this.currentDifficulty];
        ...
        const pipeVerticalDisty = Phaser.Math.Between(...difficulty.pipeVerticalDistanceRange);
        const pipeVerticalPosition = Phaser.Math.Between(0 + 20, this.config.height - 20 - pipeVerticalDisty);
        const pipeHorizontalDisty = Phaser.Math.Between(...difficulty.pipeHorizontalDistanceRange);
